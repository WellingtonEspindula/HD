...
class DaoEmailBoletoAtualizado
{
    ...
    {
        $sql = "SELECT idEmail, DESTINATÁRIO as destinatario, horario, HOST_idHOST as `host`, situacao, num_nota as `numeroNota`, vencimento "
        ...
        $p_sql->execute();
        $p_sql->setFetchMode(PDO::FETCH_CLASS, "EmailBoletoAtualizado");
        return $p_sql->fetch();
    }
